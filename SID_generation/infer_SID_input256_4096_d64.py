...
CKPT_PATH = './result/ae_coin_256_4096_bs2048_lr0.002_ep50_20251114_145155/checkpoint-49.pth'  # todo: 需要推理的ckpt
INPUT_FILE_PATH = './datas/ae_coin_semantic_emb_256.npz'  # 输入的emb，npz格式
OUTPUT_FILE_PATH = './result/ae_coin_256_4096_d64_sid_infer.csv'  # 输出结果
