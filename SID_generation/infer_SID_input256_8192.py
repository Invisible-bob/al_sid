...
CKPT_PATH = './result/ae_coin_256_8192_d256_bs2048_lr0.002_ep50_20251114_172608/checkpoint-49.pth'  # todo: 需要推理的ckpt
INPUT_FILE_PATH = './datas/ae_coin_semantic_emb_256.npz'  # 输入的emb，npz格式
OUTPUT_FILE_PATH = './result/ae_coin_256_8192_sid_infer.csv'  # 输出结果
...
def build_model(ckpt_path: str) -> torch.nn.Module:
    ...
    codebook_dim = 256 # TODO: 根据训练模型修改
