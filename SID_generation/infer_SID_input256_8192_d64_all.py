...
CKPT_PATH = './result/ae_coin_256_8192_d64_all_bs2048_lr0.0002_ep150_20251201_1417/checkpoint-149.pth'  # todo: 需要推理的ckpt
INPUT_FILE_PATH = './datas/ae_coin_semantic_emb_256_all.npz'  # 输入的emb，npz格式
OUTPUT_FILE_PATH = './result/ae_coin_256_8192_d64_all_sid_infer.csv'  # 输出结果
...
def build_model(ckpt_path: str) -> torch.nn.Module:
    ...
    logging.info("开始构建模型...")
    codebook_num = 3
    codebook_size = 8192 # TODO: 根据训练模型修改
    codebook_dim = 64 # TODO: 根据训练模型修改
    input_dim = 256  # TODO: 根据训练模型修改
